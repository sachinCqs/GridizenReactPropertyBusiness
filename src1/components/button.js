        ...
        return (
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <TouchableWithoutFeedback onPress={() => this.props.checkClicked()}>
                    <Image style={{}} source={this.props.selected ? require('../assets/check.png') : require('../assets/unCheck.png')} />
...
class RadioButton extends Component {
    ...
    render() {
        ...
        return (
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <TouchableWithoutFeedback onPress={() => this.props.checkClicked()}>
                    <Image style={{ tintColor: '#000' }} source={this.props.selected ? require('../assets/r-check-active.png') : require('../assets/r-check.png')} />
                </TouchableWithoutFeedback>
            ...
            <TouchableWithoutFeedback onPress={() => this.props.onButtonPress()}>
                <View style={{
                    ...
                    <View style={{
                        ...
                        alignItems: this.props.multiline ? 'flex-start' : 'center', borderColor: this.props.error ? 'red' : '#A2A8A2', borderWidth: 1, paddingHorizontal: dynamicSize(5)
                    }}>
...
export { CheckBox, RadioButton, PlusMinus, TextBoxWithTitleAndButton };
